  ...
  Widget build(BuildContext context) {
    return FlutterDeckApp(
      ...
      slides: [
        ...
        BetclicVideoSlide(
          route: '/rive-in-action',
          title: 'Rive in action',
          asset: 'assets/montage_rive.mp4',
          pageNumber: 4,
        ),
        RiveVsFlutterAnimateSlide(pageNumber: 5),
        ...
        PanelMemorySlide(pageNumber: 13),
        AssetStrategySlide(pageNumber: 14),
        GeneratorSlide(pageNumber: 15),
